...
static UniValue debug(const JSONRPCRequest& request)
{
    RPCHelpMan{"debug",
        ...
        " - \"vixel\" activates all Vixel-specific categories at once;\n"
        ...
        RPCExamples {
            HelpExampleCli("debug", "vixel")
    + HelpExampleRpc("debug", "vixel+net")
    }}.Check(request);
...
static UniValue validateaddress(const JSONRPCRequest& request)
{
            RPCHelpMan{"validateaddress",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The vixel address to validate"},
                },
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
...
static UniValue verifymessage(const JSONRPCRequest& request)
{
    RPCHelpMan{"verifymessage",
        ...
        {
            {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The vixel address to use for the signature."},
        ...
        RPCResult{
            RPCResult::Type::ARR, "", "",
            {
                {RPCResult::Type::OBJ, "", "",
                {
                    ...
                    {RPCResult::Type::NUM, "satoshis", "The difference of VIXELCOIN"},
        ...
        RPCResult{
            RPCResult::Type::ARR, "", "",
            {
                {RPCResult::Type::OBJ, "", "",
                {
                    ...
                    {RPCResult::Type::NUM, "satoshis", "The number of VIXELCOIN of the output"},
...
static UniValue getaddressbalance(const JSONRPCRequest& request)
{
    RPCHelpMan{"getaddressbalance",
        ...
        RPCResult{
            RPCResult::Type::OBJ, "", "",
                {
                    {RPCResult::Type::NUM, "balance", "The current total balance in VIXELCOIN"},
                    {RPCResult::Type::NUM, "balance_immature", "The current immature balance in VIXELCOIN"},
                    {RPCResult::Type::NUM, "balance_spendable", "The current spendable balance in VIXELCOIN"},
                    {RPCResult::Type::NUM, "received", "The total number of VIXELCOIN received (including change)"},
                }},
        RPCExamples{
    ...
    if (request.fHelp)
        throw std::runtime_error(
            RPCHelpMan{"echo|echojson ...",
                ...
                "vixel-cli and the GUI. There is no server-side difference.",
                {},
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    /* Vixel features */
    { "vixel",               "mnsync",                 &mnsync,                 {} },
    { "vixel",               "spork",                  &spork,                  {"command"} },
    { "vixel",               "sporkupdate",            &sporkupdate,            {"name","value"} },
