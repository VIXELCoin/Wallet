...
/** Utility functions used by the Vixel Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "vixel:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load vixel specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a vixel specific theme is activated (light/dark).*/
