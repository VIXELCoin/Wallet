...
//! Interface for the src/evo part of a vixel node (vixeld process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/governance part of a vixel node (vixeld process).
class GOV
{
public:
    virtual ~GOV() {}
...
//! Interface for the src/llmq part of a vixel node (vixeld process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a vixel node (vixeld process).
...
//! Top-level interface for a vixel node (vixeld process).
class Node
{
public:
    virtual ~Node() {}
