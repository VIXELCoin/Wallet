 ...
 *  We have 4 times smaller block times in Vixel, so we need to push 4 times more invs per 1MB. */
...
bool PeerManagerImpl::AlreadyHave(const CInv& inv)
{
    ...
    /*
        Vixel Related Inventory Messages
...
bool PeerManagerImpl::SendMessages(CNode* pto)
{
...

    {
        ...
        // VIX this code also handles non-TXs (Vixel specific messages)
