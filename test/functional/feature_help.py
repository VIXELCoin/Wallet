...
"""Verify that starting vixeld with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start vixeld with -h for help text")
        ...
        self.log.info("Start vixeld with -version for version information")
        ...
        self.log.info("Start vixeldd with -fakearg to make sure it does not start")
