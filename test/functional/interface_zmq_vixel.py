...
"""Test the vixel specific ZMQ notification interfaces."""
...
from test_framework.test_framework import VixelTestFramework
...
class VixelZMQTest (VixelTestFramework):
    def set_test_params(self):
        ...
        self.set_vixel_test_params(5, 4, fast_dip3_enforcement=True, extra_args=extra_args)
        self.set_vixel_llmq_test_params(4, 4)
    ...
    def run_test(self):
        self.subscribers = {}
        # Check that vixeld has been built with ZMQ enabled.
        ...
        try:
            ...
            time.sleep(1)
            # Test all vixel related ZMQ publisher
