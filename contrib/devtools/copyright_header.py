...
Arguments:
    <base_directory> - The base directory of a Vixel Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The Vixel Core developers'
...
Arguments:
    <base_directory> - The base directory of Vixel Core source code repository.
"""
...
Arguments:
    <file> - A source file in the Vixel Core repository.
"""
