# Bootstrappable Vixel Core Builds

This directory contains the files necessary to perform bootstrappable Vixel
Core builds.
...
To build Vixel Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      Vixel Core version being built.
...
```
env DETACHED_SIGS_REPO=<path/to/vixel-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/vixelpay/guix.sigs).
...
[guix-docker]: https://github.com/VIXELCoin/tree/master/contrib/guix/Dockerfile
