# Support for Output Descriptors in Vixel Core

Since Vixel Core v0.17, there is support for Output Descriptors. This is a
...
existing Vixel Core wallets, a convenience function `combo` is
...
All RPCs in Vixel Core will include the checksum in their output. Only
