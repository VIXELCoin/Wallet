...
This mechanism has been integrated into Bitcore-Node-Vixel which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/vixelpay/insight-api-vixel#web-socket-api](https://github.com/vixelpay/insight-api-vixel#web-socket-api)
* API: [https://github.com/vixelpay/insight-api-vixel#instantsend-transactions](https://github.com/vixelpay/insight-api-vixel#instantsend-transactions)
