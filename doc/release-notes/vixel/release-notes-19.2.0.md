...
At the first startup Vixel Core will run a migration process which can take
...
incompatible with older versions of Vixel Core, so a db migration path was
...
See detailed [set of changes](https://github.com/VIXELCoin/compare/v19.1.0...vixelpay:v19.2.0).
