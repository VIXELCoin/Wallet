...
- `wipetxes`: New command for `vixel-wallet` that removes all wallet transactions
...
See detailed [set of changes](https://github.com/VIXELCoin/compare/v19.2.0...vixelpay:v19.3.0).
