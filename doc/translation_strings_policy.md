...
This document provides guidelines for internationalization of the Vixel Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `vixel_en.ts` remains unchanged.
